#paralleled model&results output:train south; test north
library(dplyr)
library(survival)
library(pROC)
library(readr)
...
target_values0 <- c(11001,11002,11003,11006,11007,11008,11022,11023,10003,11013,11014,11016,11018,11020,11021,11012,11011)
target_values1 <- c(11004,11005,11009,11017,11010)
train_data <- All[All$Region %in% target_values0, ]
test_data  <- All[All$Region %in% target_values1, ]
